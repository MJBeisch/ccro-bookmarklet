...
function CCRORenderConvertExperimentList(experiments,activeExperiments,experimentNameKey,experimentVariationsKey){var CCROvalidationCookieCheck='', ConvertVariationCookie=CCROreadCookie('_conv_v'), experimentIds=Object.keys(experiments), activeExperimentIds=Object.keys(activeExperiments), experimentLoop=0, activeStateLoop=0;
 if(experimentIds.length>0){ jQuery(".CCROoverlayuicontent").append("<table class=\"experimentlist\"><caption>Convert Experiences Experiment List</caption><thead><tr><th class=\"experiment-name\">Experiment Name</th><th class=\"variations\">Variations</th><!--<th class=\"results-link\">Results</th>--></tr></thead><tbody></tbody></table>"); for(;experimentLoop<experimentIds.length;++experimentLoop){var experimentId=experimentIds[experimentLoop], experimentName=experiments[experimentId][experimentNameKey], experimentVariations=experiments[experimentId][experimentVariationsKey], experimentVariationIds=Object.keys(experimentVariations), variationLoop=0, variationOptions="";
...
else if(window.convert.data.experiences){CCRORenderConvertExperimentList(window.convert.data.experiences,window.convert.currentData.experiences,"name","variations");}}
