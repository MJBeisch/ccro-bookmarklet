...
window.location.reload(true);}); jQuery(".CCROv-close").click(function(){CCROclose();}); jQuery(".CCROv-toggle").click(function(){CCROtoggle();}); if(window.convert.data.experiments){CCRORenderConvertExperimentList(window.convert.data.experiments);} 
else if(window.convert.data.experiences){CCRORenderConvertExperimentList(window.convert.data.experiences);}}
